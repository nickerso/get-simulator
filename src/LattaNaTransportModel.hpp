/*
 * LattaNaTransportModel.hpp
 *
 *  Created on: Sep 12, 2012
 *      Author: dnic019
 */

#ifndef LATTANATRANSPORTMODEL_HPP_
#define LATTANATRANSPORTMODEL_HPP_

#include <vector>

/**
 * This class defines all the Na transport model from the Latta et al (1984)
 * modelling of epithelial transport paper.
 */
class LattaNaTransportModel
{
public:
	LattaNaTransportModel();
	~LattaNaTransportModel();
	 ...
	 */
    double solveForElectroneutrality(int& errorFlag, const bool updateOnly = false);

	/**
	 * Solve for electroneutrality in the voltage-clamp case (fig 3 in Latta paper).
	 */
    double solveForElectroneutralityVoltageClamp(const bool updateOnly = false);
...
#endif /* LATTANATRANSPORTMODEL_HPP_ */
